                           ...
                           <!-- Product Details Left -->
                            <div class="product-details-left">
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">      
                                    ...
                                    <div class="sm-image"><img src="{{ asset($img->imageName)}}" alt="product image thumb"></div>
                                    @endforeach
                            ...
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <div class="price-box pt-20">
                                        <span class="new-price new-price-2">RM {{  $product->productPrice}}</span>
                                    </div>
                                    <div class="product-desc">
                                        <p>
                                            <span> {{   $product->productDescription}}
                                            </span>
                                        </p>
                                    </div>
            ...
            <div class="product-area pt-35">
                <div class="container">
                        ...
                        <div class="col-lg-12">
                            <div class="li-product-tab">
                                <ul class="nav li-product-menu">
                                   ...
                                   <li><a data-toggle="tab" href="#feedback"><span>Feedback</span></a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="feedback" class="tab-pane" role="tabpanel">
