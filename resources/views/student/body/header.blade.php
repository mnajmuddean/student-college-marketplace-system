                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hb-menu  d-xl-block">
                                    <nav>
                                        <ul>
                                            <li class=""><a href="index.html">Home</a></li>

                                            @php 
                                            $categories = App\Models\Category::orderBy('categoryName','ASC')->get();
                                            ...
                                            @endforeach
                                            <li class="dropdown-holder"><a href="blog-left-sidebar.html">About Us</a>
